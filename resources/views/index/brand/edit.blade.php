...
<body>
<center><h1>tank-architect - 品牌编辑</h1></center>
<form  action="{{url('/brand/update/'.$res->brand_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="brand_name" id="firstname" 
				   placeholder="请输入品牌名称" value="{{$res->brand_name}}">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			@if($res->brand_logo)<img src="{{env('UPLOAD_URL')}}{{$res->brand_logo}}"width="50px"height="50px">@endif
